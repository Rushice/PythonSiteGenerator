...
from src.util.splitnodes import split_nodes_delimiter, split_nodes_image, split_nodes_link, text_to_textnodes
...
class TestSplitNodes(unittest.TestCase):
  ...
  def test_split_mixed_block(self):
    bold = TextNode("This is BOLD", TextType.BOLD)
    code = TextNode("This is CODE", TextType.CODE)
    node = TextNode("This is text with a _italic block_ word", TextType.TEXT)
    new_nodes = split_nodes_delimiter([bold,code,node], "_", TextType.ITALIC)
